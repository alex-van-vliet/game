...
namespace libsdl {
    namespace detail {
        ...
        public:
            ...
            static constexpr out_t call(in_t &t) {
                return t.get();
            }

            static constexpr out_t call(const in_t &t) {
                return t.get();
            }
        ...
        auto as_raw(auto &&in) {
            ...
            if constexpr (as_raw_t::implemented) {
                return AsRaw<std::remove_cvref_t<decltype(in)>>::call(std::forward<decltype(in)>(in));
            } else {
                return in;
            }
        }
    ...
    public:
        ...
        constexpr out_t operator()(auto &&... arguments) const {
            return FUN{}(detail::as_raw(std::forward<decltype(arguments)>(arguments))...);
        }
    };
}
